...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void setup() {
    // instantiate location wrapper with onLocationChangedCallback
    // which publishes the new location to mqtt server
    locationWrapper = LocationWrapper((newLocation) => mqttClientWrapper.publishLocation(newLocation));

    // instantiate mqtt client wrapper with on connected callback and
    // on-newlocation received callback
    mqttClientWrapper = MQTTClientWrapper(
  ...
  /// Redraws the map marker to updated location
